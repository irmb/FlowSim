package irmb.flowsim.lbm.numerics.acm;
...
public class AcmGridNode {
    ...
    public void setturbvisc(double Turbvisc) {
        this.turbvisc[0] = Turbvisc;
        this.turbvisc[1] = Turbvisc;
    }

    public void setP(double P, int id) {
        this.p[id] = P;
    }

    public void setU(double U, int id) {
        this.u[id] = U;
    }

    public void setV(double V, int id) {
        this.v[id] = V;
    }

    public void setturbvisc(double Turbvisc, int id) {
        this.turbvisc[id] = Turbvisc;
    }
    ...
    public double getU(int id) {
        return this.u[id];
    }

    public double getV(int id) {
        return this.v[id];
    }

    public double getTurbulentViscosity(int id) {
        return this.turbvisc[id];
    }
    ...
    public void setMedicine(double medi) {
        this.medicine = medi;
    }
