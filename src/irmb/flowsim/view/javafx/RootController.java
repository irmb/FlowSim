...
public class RootController implements GraphicView {
    ...
    public void onCircleButtonClick(ActionEvent event) {
        presenter.beginPaint("Circle");
    }

    public void onTriangleButtonClick(ActionEvent event) {
        presenter.beginPaint("Triangle");
    }
    ...
    public void onSplineButtonClick(ActionEvent event) { presenter.beginPaint("Spline"); }
    ...
    public void onIsolineChecked(ActionEvent event) {
        presenter.togglePlotStyle(PlotStyle.Isoline);
    }
